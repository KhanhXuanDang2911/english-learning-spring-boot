...
public class CategoryCourseServiceImpl implements CategoryCourseService {
    ...
    public CategoryCourseResponse create(CategoryCourseRequest request) {
        ...
        if (entity.getTitle() != null) {
            entity.setSlug(AppUtils.renderSlug(entity.getTitle()));
        }
    ...
    @Override
    public PageResponse<List<CategoryCourseResponse>> getCategoriesWithPaginationAndKeyword(int pageNumber, int pageSize, java.util.List<String> sorts, String keyword) {

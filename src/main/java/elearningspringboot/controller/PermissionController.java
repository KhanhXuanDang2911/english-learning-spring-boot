...
public class PermissionController {
    ...
    public ResponseEntity<ResponseData<PageResponse<List<PermissionResponse>>>> getAll(
        ...
        String message = messageSource.getMessage("permission.get.list.success", null, LocaleContextHolder.getLocale());
    ...
    public ResponseEntity<ResponseData<PermissionResponse>> getById(
        ...
        String message = messageSource.getMessage("permission.get.success", null, LocaleContextHolder.getLocale());
        return ResponseBuilder.withData(HttpStatus.OK, message, response);
    }
    ...
    public ResponseEntity<ResponseData<PermissionResponse>> create(@RequestBody @Validated PermissionRequest request) {
        ...
        String message = messageSource.getMessage("permission.create.success", null, LocaleContextHolder.getLocale());
    ...
    public ResponseEntity<ResponseData<PermissionResponse>> update(
        ...
        String message = messageSource.getMessage("permission.update.success", null, LocaleContextHolder.getLocale());
        return ResponseBuilder.withData(HttpStatus.OK, message, response);
    }
    ...
    public ResponseEntity<ResponseData<Void>> delete(
        ...
        String message = messageSource.getMessage("permission.delete.success", null, LocaleContextHolder.getLocale());
